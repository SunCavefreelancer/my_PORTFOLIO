(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".services__slider")) new swiper_core_Swiper(".services__slider", {
            ...
            pagination: {
                ...
                renderFraction: function(currentClass, totalClass) {
                    return '<span class="' + currentClass + '"></span>' + "<span class='of'> of </span> " + '<span class="' + totalClass + '"></span>';
                }
            },
            navigation: {
        ...
        //! ------------------slider 2--------potfolio-----
                if (document.querySelector(".next__slider")) new swiper_core_Swiper(".next__slider", {
            modules: [ Navigation, Pagination, Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 2,
            ...
            navigation: {
                prevEl: ".next__btn-left",
                nextEl: ".next__btn-right"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".desing__slider")) new swiper_core_Swiper(".desing__slider", {
            modules: [ Navigation, Pagination, Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 2,
